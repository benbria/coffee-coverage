...
(function() {
  var COFFEE_EXTENSION, CoverageError, JS_EXTENSION, abbreviatedPath, coffeeScript, defaultOptions, defaults, endsWith, events, fs, mkdirs, path, pkginfo, stripLeadingDot, util, _ref,
  ...
  _ref = require('./helpers'), endsWith = _ref.endsWith, defaults = _ref.defaults, abbreviatedPath = _ref.abbreviatedPath, mkdirs = _ref.mkdirs, stripLeadingDot = _ref.stripLeadingDot;
  ...
  exports.CoverageInstrumentor = (function(_super) {
    var fileToLines, fixLocationData, generateUniqueName, nodeType, statFile, toQuotedString, validateSrcDest, writeToFile;
    ...
    CoverageInstrumentor.prototype.instrumentCoffee = function(fileName, fileData) {
      var ast, fileToInstrumentLines, index, instrumentTree, instrumentedLines, line, lineNumber, options, out, quotedFilename, _i, _j, _len, _len1;
